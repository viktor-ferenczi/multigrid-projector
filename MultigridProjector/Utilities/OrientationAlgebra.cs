...
namespace MultigridProjector.Utilities
{
    public static class OrientationAlgebra
    {
        ...
        private static readonly Vector3I[] ProjectionRotations =
        {
            ...
            new Vector3I(-2, -2, -1), new Vector3I(-2, -2, 1),
            new Vector3I(-2, -2, -2), new Vector3I(-2, -2, 0),

            Vector3I.Zero, Vector3I.Zero,
            new Vector3I(-2, 0, -1), new Vector3I(-2, 0, 1),
            new Vector3I(-2, 0, 0), new Vector3I(-2, 0, -2),
            new Vector3I(-1, -2, 1), new Vector3I(-1, -2, -1),

            Vector3I.Zero, Vector3I.Zero,
            new Vector3I(-1, -2, -2), new Vector3I(-1, -2, 0),
            new Vector3I(-1, 0, 1), new Vector3I(-1, 0, -1),

            Vector3I.Zero, Vector3I.Zero,
            new Vector3I(-1, 0, 0), new Vector3I(-1, 0, -2),
            new Vector3I(-2, 1, 0), new Vector3I(-2, 1, -2),
            new Vector3I(-2, 1, -1), new Vector3I(-2, 1, 1),

            Vector3I.Zero, Vector3I.Zero,
            new Vector3I(-2, -1, -2), new Vector3I(-2, -1, 0),
            new Vector3I(-2, -1, -1), new Vector3I(-2, -1, 1),
